...
import com.own.user_service.model.*;
import com.own.user_service.repo.*;
import com.own.user_service.request.LoginRequest;
...
public class UserController {
	...
	public ResponseEntity<String> fallbackLoginUser(LoginRequest loginRequest) { // Log the error or perform any
																					// necessary handling
