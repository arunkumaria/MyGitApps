package com.own.task_service.controller;

import com.own.task_service.enums.*;
import com.own.task_service.service.TaskService;
import com.own.task_service.service.UserService;
import com.own.task_service.model.Task;
...
public class TaskController {
	...
	@GetMapping("/user")
	public ResponseEntity<List<Task>> getAssignedUsersTask(@RequestHeader("Authorization") String jwt,
			@RequestParam(required = false) TaskStatus status, @RequestParam(required = false) String sortByDeadline,
	...
	public ResponseEntity<Task> assignedTaskToUser(@PathVariable String id, @PathVariable String userId,
