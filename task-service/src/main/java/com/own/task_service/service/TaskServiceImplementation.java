...
import com.own.task_service.repo.TaskRepository;
...
public class TaskServiceImplementation implements TaskService {
	...
	public List<Task> assignedUsersTask(String userId, TaskStatus taskStatus) {
		...
		return allTasks.stream().filter(task -> taskStatus == null || task.getStatus() == taskStatus)
				.collect(Collectors.toList());
	}
	...
	public List<Task> assignedUsersTask(String userId, TaskStatus status, String sortByDeadline,
