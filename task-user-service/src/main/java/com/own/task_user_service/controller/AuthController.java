package com.own.task_user_service.controller;

import com.netflix.hystrix.contrib.javanica.annotation.HystrixCommand;
import com.own.task_user_service.exception.*;
import com.own.task_user_service.repo.*;
import com.own.task_user_service.request.*;
import com.own.task_user_service.response.AuthResponse;
import com.own.task_user_service.service.*;
import com.own.task_user_service.config.*;
...
public class AuthController {
	...
	public AuthController(UserRepository userRepository, PasswordEncoder passwordEncoder,
			CustomerServiceImplementation customUserDetails, UserService userService) {
		super();
	...
	public ResponseEntity<AuthResponse> createUserFallback(User user, Throwable throwable) {
		// Handle the fallback logic here, You can return a default response or log the
		// error
		AuthResponse authResponse = new AuthResponse();
