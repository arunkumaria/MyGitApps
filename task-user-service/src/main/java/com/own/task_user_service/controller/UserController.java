...
import com.own.task_user_service.response.*;
...
public class UserController {
	...
	public ResponseEntity<User> fallbackForGetUserProfile(String jwt, Throwable throwable) {
		// Handle the fallback logic here, For example, you can return a default user or
	...
	public ResponseEntity<User> findUserById(@PathVariable String userId, @RequestHeader("Authorization") String jwt)
	...
	public ResponseEntity<List<User>> fallbackForFindAllUsers(String jwt, Throwable throwable) {
		// Handle the fallback logic here, For example, you can return an empty list or
		// a custom error message
